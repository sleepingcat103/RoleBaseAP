...
; (function ($w) {
    ...
    jm.prototype = {
        ...
        _event_bind: function () {
            this.view.add_event(this, 'mousedown', this.options.mousedown_handle || this.mousedown_handle);
            this.view.add_event(this, 'click', this.options.click_handle || this.click_handle);
            this.view.add_event(this, 'dblclick', this.options.dblclick_handle || this.dblclick_handle);
        },
