...
var answerPackController = function () {
  ...
  function __init__() {
    ...
    $editArea.on('click', '[field="select-file"] button', function (e) {
      var target = $(e.currentTarget).attr('target');
  ...
  function initPage() {
    ...
    callBackendAPI('/listAnswerpack', 'POST', body).then(function (response) {
      ...
      var target = $answerpacksField.find('div[content="answerpack"]').toArray().find(function (btn) {
  ...
  function loadDocuments() {
    ...
    callBackendAPI('/listFiles', 'POST', body).then(function (response) {
      var myHtml = response.result.map(function (file) {
        return "\n                <li>\n                    <div>\n                        <button type=\"button\" class=\"btn btn-sm btn-outline-info\" action=\"selectFile\" filePath=\"".concat(mainController.toPatterns(file.filePath), "\">\n                            <i class=\"fas fa-check\"></i>\n                        </button>\n                        ").concat(file.fileName, "\n                    </div>\n                </li>");
      });
